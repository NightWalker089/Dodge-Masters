...
class Player:
    def __init__(self, win):
        self.win = win
        self.image = pygame.image.load("player_photo.png")  # Use the live photo captured
        self.image = pygame.transform.scale(self.image, (60, 60))  # Adjust size for larger screen
        self.reset()
...
class Ball(pygame.sprite.Sprite):
    def __init__(self, x, y, type, color, win):
        ...
        self.rect = pygame.draw.circle(win, self.c, (x, y), 6)
    ...
    def update(self, speed):
        ...
        pygame.draw.circle(self.win, self.gray, (self.x + 2, self.y + 2), 7)
